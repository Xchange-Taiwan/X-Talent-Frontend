...
describe('useOverflowFit', () => {
  it('returns isMeasuring: true and full length when containerWidth is null', () => {
  ...
  it('returns isMeasuring: true when itemWidths is empty', () => {
    const { result } = renderHook(() =>
      useOverflowFit({
        itemWidths: [],
        containerWidth: 100,
  ...
  it('returns isMeasuring: true when all itemWidths are 0', () => {
    const { result } = renderHook(() =>
      useOverflowFit({
        itemWidths: [0, 0, 0],
        containerWidth: 100,
