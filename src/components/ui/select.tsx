...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'border-background-border bg-background-white ring-offset-background-white placeholder:text-text-tertiary flex h-10 w-full items-center justify-between rounded-md border px-3 py-2 text-base disabled:cursor-not-allowed disabled:opacity-50 md:text-sm [&>span]:line-clamp-1',
      FOCUS_RING_CLASSES,
      className
    )}
    {...props}
