            ...
            {bookedSlots.map((slot) => {
              ...
              return (
                <div
                  ...
                  className="border-background-border hover:bg-background-bottom/50 relative flex w-full items-center justify-between rounded-lg border px-4 py-3 text-left text-sm font-medium transition-colors"
                >
