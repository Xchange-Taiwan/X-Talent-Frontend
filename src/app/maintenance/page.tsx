    ...
    <div className="bg-light fixed inset-0 z-[9999] flex flex-col items-center justify-center px-6 py-12 text-center">
      <div className="flex w-full max-w-md flex-col items-center">
        ...
        <button
          ...
          className={cn(
            'bg-brand-500 text-text-white hover:bg-brand-600 inline-flex items-center gap-2 rounded-lg px-6 py-3 font-semibold shadow-sm transition-all focus:outline-none disabled:opacity-50',
            FOCUS_RING_CLASSES
          )}
        >
          <RefreshCw
