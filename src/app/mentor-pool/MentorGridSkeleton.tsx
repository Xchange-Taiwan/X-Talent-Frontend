    ...
    >
      ...
      <div className="px-4 pt-4 pb-6">
        ...
        <div className="flex gap-2">
          <div className="h-6 w-16 rounded-full bg-background-bottom" />
          <div className="h-6 w-20 rounded-full bg-background-bottom" />
          <div className="h-6 w-14 rounded-full bg-background-bottom" />
        </div>
      </div>
    </div>
  );
