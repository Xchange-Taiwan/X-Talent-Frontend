...
module.exports = {
  ...
  rules: {
    ...
    'no-restricted-syntax': [
      ...
      {
        selector:
          "JSXAttribute[name.name='className'] Literal[value=/(^|\\s|:)(bg|text|border(-[trblxy])?|ring(-offset)?|fill|stroke|from|via|to|divide|shadow|outline|placeholder|decoration|accent|caret)-\\[(#|rgba?|hsla?)/], JSXAttribute[name.name='className'] TemplateElement[value.raw=/(^|\\s|:)(bg|text|border(-[trblxy])?|ring(-offset)?|fill|stroke|from|via|to|divide|shadow|outline|placeholder|decoration|accent|caret)-\\[(#|rgba?|hsla?)/], CallExpression[callee.name=/^(cn|clsx|cva)$/] Literal[value=/(^|\\s|:)(bg|text|border(-[trblxy])?|ring(-offset)?|fill|stroke|from|via|to|divide|shadow|outline|placeholder|decoration|accent|caret)-\\[(#|rgba?|hsla?)/], CallExpression[callee.name=/^(cn|clsx|cva)$/] TemplateElement[value.raw=/(^|\\s|:)(bg|text|border(-[trblxy])?|ring(-offset)?|fill|stroke|from|via|to|divide|shadow|outline|placeholder|decoration|accent|caret)-\\[(#|rgba?|hsla?)/]",
        message:
          'Do not use arbitrary hex, rgb, or hsl colors (e.g. text-[#...], bg-[rgba(...)], border-[hsl(...)]) in Tailwind classes. Please use standard theme colors from tailwind.config.js.',
      },
      {
        selector:
